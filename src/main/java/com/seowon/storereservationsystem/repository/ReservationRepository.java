...
public interface ReservationRepository extends JpaRepository<Reservation, Long> {
    @Query("SELECT r FROM Reservation r WHERE r.user.userId = :userId ORDER BY r.reserveTime")
    List<Reservation> findByUserUserIdOrOrderByReserveTime(String userId);
